  ...
  return (
    <PolicyLayout title="Terms & Conditions" icon={FileText}>
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-4">For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean RAMASAMY SUDARSHAN BALAKRISHNA, whose registered/operational office is No 5 Flat 1B Shreshta Sri Sudarshan Apartments, Seshadri Road, Alwarpet Chennai TAMIL NADU 600018. "you", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.</p>
        
        <p className="mb-6 font-semibold">Your use of the website and/or purchase from us are governed by following Terms and Conditions:</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3">
          ...
          <li>You may not create a link to our website from another website or document without RAMASAMY SUDARSHAN BALAKRISHNA's prior written consent.</li>
