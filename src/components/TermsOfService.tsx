  ...
  return (
    <PolicyLayout title="Terms & Conditions" icon={FileText}>
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-4">For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean PECHE EMPIRE, whose registered/operational office is No.57, Jalan Wangsa Jaya 2, Taman Wangsa Jaya 53300 Kuala Lumpur. "you", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3">
          ...
          <li>You may not create a link to our website from another website or document without PECHE EMPIRE's prior written consent.</li>
