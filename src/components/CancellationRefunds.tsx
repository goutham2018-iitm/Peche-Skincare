  ...
  return (
    <PolicyLayout title="Cancellation & Refund Policy" icon={RefreshCw}>
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-6">RAMASAMY SUDARSHAN BALAKRISHNA believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3">
          ...
          <li>RAMASAMY SUDARSHAN BALAKRISHNA does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
          ...
          <li>In case of any Refunds approved by the RAMASAMY SUDARSHAN BALAKRISHNA, it'll take the standard processing time for the refund to be processed to the end customer.</li>
        </ul>
