  ...
  return (
    <PolicyLayout title="Privacy Policy" icon={ShieldCheck}>
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-4">This privacy policy sets out how RAMASAMY SUDARSHAN BALAKRISHNA uses and protects any information that you give RAMASAMY SUDARSHAN BALAKRISHNA when you visit their website and/or agree to purchase from them.</p>
        
        <p className="mb-4">RAMASAMY SUDARSHAN BALAKRISHNA is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement.</p>
        
        <p className="mb-6">RAMASAMY SUDARSHAN BALAKRISHNA may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you adhere to these changes.</p>
        ...
        <p className="mb-6">If you believe that any information we are holding on you is incorrect or incomplete, please write to No 5 Flat 1B Shreshta Sri Sudarshan Apartments, Seshadri Road, Alwarpet Chennai TAMIL NADU 600018 or contact us as soon as possible. We will promptly correct any information found to be incorrect.</p>
        
        <p className="text-sm text-gray-500 italic">Disclaimer: The above content is created at RAMASAMY SUDARSHAN BALAKRISHNA's sole discretion. Razorpay shall not be liable for any content provided here and shall not be responsible for any claims and liability that may arise due to merchant's non-adherence to it.</p>
      </div>
    </PolicyLayout>
  );
};
