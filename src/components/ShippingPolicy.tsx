  ...
  return (
    <PolicyLayout title="Shipping & Delivery Policy" icon={Truck}>
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-6">For any issues in utilizing our services you may contact our helpdesk on <a href="tel:6382355601" className="text-primary hover:underline">6382355601</a> or <a href="mailto:peche.purpose@gmail.com" className="text-primary hover:underline">peche.purpose@gmail.com</a></p>
